...
export function isWithinDays(value: Date | null, start: Date, dayCount: number): boolean {
...
export function isPast(value: Date | null): boolean {
  return value ? startOfDay(value).getTime() < startOfDay(new Date()).getTime() : false
}
...
export function formatLongDate(value: Date, settings: any): string {
