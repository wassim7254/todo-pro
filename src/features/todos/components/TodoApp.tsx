  ...
  return (
    <div className="app-bg min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="mx-auto max-w-[1440px]">
        <div
          className="
            app-surface min-h-[calc(100vh-2rem)] overflow-hidden
            rounded-[34px] border-2 border-foreground p-5
...
export function TodoApp() {
  ...
  const completionRatio =
    manager.metrics.total > 0
      ? Math.round(
          (manager.metrics.completed / manager.metrics.total) * 100,
        )
      : 0
  ...
  const openTask = (todo: Todo) =>
    setSheet({ mode: 'detail', todoId: todo.id })
  ...
  const categoryStyles: Record<
    string,
    { dot: string; active: string; accent: string }
  > = {
    personal: {
      dot: 'bg-[#ee6f96]',
      active:
        'border-[#ee6f96]/35 bg-[#ee6f96]/10 text-[#ee6f96]',
      accent: '#ee6f96',
    },
    work: {
      dot: 'bg-[#7764e8]',
      active:
        'border-[#7764e8]/35 bg-[#7764e8]/10 text-[#7764e8]',
      accent: '#7764e8',
    },
    study: {
      dot: 'bg-[#35a995]',
      active:
        'border-[#35a995]/35 bg-[#35a995]/10 text-[#35a995]',
      accent: '#35a995',
    },
    health: {
      dot: 'bg-[#ed8664]',
      active:
        'border-[#ed8664]/35 bg-[#ed8664]/10 text-[#ed8664]',
      accent: '#ed8664',
    },
    other: {
      dot: 'bg-[#d9a62e]',
      active:
        'border-[#d9a62e]/35 bg-[#d9a62e]/10 text-[#d9a62e]',
      accent: '#d9a62e',
    },
  }
  ...
  return (
    <div className="app-bg min-h-screen">
      <div className="mx-auto min-h-screen max-w-[1440px] px-0 lg:px-5 lg:py-5 xl:px-7">
        <main
          className="
            app-surface relative min-h-screen overflow-hidden
            border-x border-foreground px-4 pb-28 pt-5
            sm:px-7 sm:pt-7
            lg:min-h-0 lg:rounded-[38px] lg:border-2 lg:px-9 lg:py-9
        ...
        >
          <div
            aria-hidden="true"
            className="pointer-events-none absolute -right-28 top-20 size-72 rounded-full bg-[#ee6f96]/10 blur-3xl"
          />
          <div
            aria-hidden="true"
            className="pointer-events-none absolute -left-28 top-[520px] size-72 rounded-full bg-[#35a995]/10 blur-3xl"
          />
          <div
            aria-hidden="true"
            className="pointer-events-none absolute right-1/4 top-[850px] size-60 rounded-full bg-[#7764e8]/8 blur-3xl"
          />
          ...
          <header className="relative z-10 mb-7">
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0">
                ...
                <p className="mt-2 text-sm font-black uppercase tracking-wider text-muted-foreground">
                  {t('app.tagline', {
                    defaultValue: 'a quieter way to plan',
                  })}
                </p>
              </div>
              ...
              <div className="hidden items-center gap-2 sm:flex">
                <button
                  type="button"
                  className="group relative grid size-12 place-items-center rounded-[18px] border-2 border-foreground/10 bg-card text-[#7764e8] shadow-[3px_3px_0_rgba(0,0,0,0.08)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[4px_4px_0_rgba(0,0,0,0.12)] active:translate-y-0"
                >
                  <Bell
                    size={19}
                ...
                <select
                  ...
                  className="h-12 max-w-[128px] rounded-[18px] border-2 border-foreground/10 bg-card px-3 text-xs font-black text-foreground shadow-[3px_3px_0_rgba(0,0,0,0.08)] outline-none transition hover:border-foreground/30 focus:border-[#35a995]"
                >
                ...
                <button
                  type="button"
                  onClick={openProfile}
                  className="group relative grid size-12 place-items-center overflow-hidden rounded-[18px] border-2 border-foreground/10 bg-card shadow-[3px_3px_0_rgba(0,0,0,0.08)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[4px_4px_0_rgba(0,0,0,0.12)] active:translate-y-0"
                >
                  {avatar ? (
                    <img
                      src={avatar}
                ...
                <button
                  ...
                  className="group grid size-12 place-items-center rounded-[18px] border-2 border-foreground/10 bg-card text-[#d9a62e] shadow-[3px_3px_0_rgba(0,0,0,0.08)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[4px_4px_0_rgba(0,0,0,0.12)] active:translate-y-0"
                >
                  <Settings
                    size={19}
            ...
            <div className="mt-7 hidden sm:block">
              <div className="inline-flex rounded-[22px] border-2 border-foreground/10 bg-muted/60 p-1.5 shadow-[3px_3px_0_rgba(0,0,0,0.04)]">
                {(['today', 'week', 'upcoming', 'all'] as TodoView[]).map(
                  (item) => {
                    const active = view === item
                    const accent =
                      item === 'today'
                        ? 'from-[#ee6f96] to-[#ed8664]'
                        : item === 'week'
                          ? 'from-[#7764e8] to-[#9b82f4]'
                          : item === 'upcoming'
                            ? 'from-[#35a995] to-[#52c6ae]'
                            : 'from-[#d9a62e] to-[#edc65d]'
                    ...
                    return (
                      <button
                        ...
                        className={`relative overflow-hidden rounded-[16px] px-5 py-2.5 text-sm font-black transition-all duration-200 active:scale-[0.98] ${
                          active
                            ? `bg-gradient-to-r ${accent} text-white shadow-[3px_3px_0_rgba(0,0,0,0.10)]`
                            : 'text-muted-foreground hover:bg-card hover:text-foreground'
                        }`}
                      >
                        {active && (
                          <>
                            <span className="absolute -right-3 -top-4 size-10 rounded-full bg-white/20 blur-md" />
                            <span className="absolute bottom-1 left-2 size-1 rounded-full bg-white/60" />
                          </>
                        )}
          ...
          <section className="relative mb-7 overflow-hidden rounded-[34px] border-2 border-foreground bg-gradient-to-br from-[#7764e8]/15 via-card to-[#ee6f96]/15 p-5 shadow-[6px_6px_0_rgba(0,0,0,0.08)] sm:p-8">
            <div className="pointer-events-none absolute -right-16 -top-24 size-64 rounded-full bg-[#ee6f96]/20 blur-3xl" />
            <div className="pointer-events-none absolute -bottom-28 -left-20 size-64 rounded-full bg-[#35a995]/15 blur-3xl" />

            <DoodleStar className="right-9 top-8 hidden size-9 rotate-12 text-[#ee6f96]/60 sm:block" />
            <DoodleSmile className="bottom-5 right-10 hidden size-16 -rotate-6 text-[#35a995]/40 sm:block" />

            <div className="relative">
              <div className="flex flex-wrap items-center gap-2">
                <Sticker
                  className="border-[#7764e8]/20 text-[#7764e8]"
                  rotate={-2}
                >
                  {formatLongDate(selectedDate)}
                </Sticker>

                <span className="size-2 rotate-45 rounded-[3px] bg-[#ee6f96]" />

                <Sticker
                  className="border-[#35a995]/20 text-[#35a995]"
                  rotate={2}
                >
                  {viewLabels[view]}
                </Sticker>
              ...
              <div className="max-w-3xl">
                <h2 className="mt-5 text-[34px] font-black leading-[0.98] tracking-[-0.07em] text-foreground sm:text-[52px] lg:text-[58px]">
                  ...
                  <span className="relative inline-block">
                    {displayName}
                    <span className="absolute -bottom-1 left-0 h-2 w-full -rotate-1 rounded-full bg-[#ee6f96]/25" />
                  </span>
                  <span className="text-[#ee6f96]">.</span>
                </h2>

                <p className="mt-4 max-w-xl text-sm font-black uppercase leading-6 tracking-tight text-muted-foreground sm:text-base">
                  {manager.metrics.dueToday
                    ? t('greeting.nudges', {
                        count: manager.metrics.dueToday,
                      })
                    : t('greeting.open', {
                        defaultValue: 'Your day is beautifully open.',
                      })}
                </p>
              </div>
          ...
          <div className="relative z-10 grid gap-7 xl:grid-cols-[minmax(0,1fr)_285px]">
            <div className="min-w-0">
              <section className="relative overflow-hidden rounded-[30px] border-2 border-foreground bg-card shadow-[5px_5px_0_rgba(0,0,0,0.08)]">
                <div className="pointer-events-none absolute -right-10 -top-12 size-32 rounded-full bg-[#35a995]/10 blur-2xl" />
              ...
              <section className="mt-7">
                ...
                <div className="flex gap-2.5">
                  <label className="relative flex-1">
                    <Search
                      className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-[#7764e8]"
                      size={18}
                    />
                    ...
                    <input
                      ...
                      placeholder={t('search.placeholder', {
                        defaultValue: 'Search your tasks',
                      })}
                      className="h-[54px] w-full rounded-[21px] border-2 border-foreground/10 bg-card py-3 pl-11 pr-4 text-sm font-black text-foreground shadow-[3px_3px_0_rgba(0,0,0,0.05)] outline-none transition focus:border-[#7764e8] focus:ring-4 focus:ring-[#7764e8]/10"
                    />
                  </label>
                  ...
                  <button
                    ...
                    className={`grid size-[54px] shrink-0 place-items-center rounded-[21px] border-2 transition-all duration-200 active:scale-95 ${
                ...
                {showFilters && (
                  <motion.div
                    ...
                    className="mt-3 overflow-hidden rounded-[25px] border-2 border-foreground/10 bg-muted/40 p-3 shadow-[3px_3px_0_rgba(0,0,0,0.04)] sm:p-4"
                  >
                    <div className="grid gap-3 sm:grid-cols-3">
                      <label className="text-xs font-black uppercase text-muted-foreground">
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setPriority(
                              e.target.value as TodoFilters['priority'],
                            )
                          }
                      ...
                      <label className="text-xs font-black uppercase text-muted-foreground">
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setCompletion(
                              e.target.value as TodoFilters['completion'],
                            )
                          }
                          className="mt-1.5 w-full rounded-[16px] border-2 border-foreground/10 bg-card px-3 py-2.5 text-sm font-black outline-none focus:border-foreground"
                        >
                      ...
                      <label className="text-xs font-black uppercase text-muted-foreground">
                        ...
                        <select
                          ...
                          onChange={(e) => {
                            const nextSort =
                              e.target.value as TodoFilters['sort']
                            setSort(nextSort)
                            updateTasks({ sort: nextSort })
                          }}
                          className="mt-1.5 w-full rounded-[16px] border-2 border-foreground/10 bg-card px-3 py-2.5 text-sm font-black outline-none focus:border-foreground"
                        >
                ...
                <div className="hide-scrollbar mt-3 flex gap-2 overflow-x-auto pb-1">
                  <button
                    ...
                    className={`shrink-0 rounded-full border-2 px-4 py-2.5 text-xs font-black transition-all ${
                      category === 'all'
                        ? 'border-foreground bg-gradient-to-r from-[#7764e8] to-[#ee6f96] text-white shadow-[3px_3px_0_rgba(0,0,0,0.1)]'
                        : 'border-foreground/10 bg-card text-muted-foreground hover:bg-muted'
                    }`}
                  >
                  ...
                  {categories.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          setCategory(active ? 'all' : item.id)
                        }
                        className={`inline-flex shrink-0 items-center gap-2 rounded-full border-2 px-4 py-2.5 text-xs font-black transition-all ${
                          active
                            ? `${styles.active} border-foreground shadow-[3px_3px_0_rgba(0,0,0,0.05)]`
                            : 'border-foreground/10 bg-card text-muted-foreground hover:bg-muted'
                        }`}
                      >
                        <span
            ...
            <aside className="hidden xl:block">
              <div className="relative overflow-hidden rounded-[30px] border-2 border-foreground bg-gradient-to-br from-[#7764e8]/12 via-card to-[#ee6f96]/12 p-5 shadow-[5px_5px_0_rgba(0,0,0,0.07)]">
                <DoodleStar className="right-5 top-5 size-6 rotate-12 text-[#ee6f96]/50" />
                ...
                <p className="relative mt-2 text-sm font-black uppercase tracking-tight text-muted-foreground">
                  {t('productivity.task', {
                    count: manager.metrics.dueToday,
                  })}
                </p>
                ...
                <div className="mt-3 flex items-center justify-between">
                  ...
                  <span className="text-lg font-black text-[#35a995]/60">
                    ✦
                  </span>
                  <span className="text-[10px] font-black uppercase tracking-[0.12em] text-muted-foreground">
                    100%
              ...
              <div className="mt-5 rounded-[30px] border-2 border-foreground bg-card p-5 shadow-[5px_5px_0_rgba(0,0,0,0.045)]">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-[0.14em] text-[#d9a62e]">
                      Today
                    </p>
                    <h2 className="mt-1 text-base font-black tracking-[-0.03em] text-foreground">
                      {t('productivity.glance', {
                        defaultValue: 'At a glance',
                      })}
                    </h2>
                  </div>

                  <span className="grid size-9 place-items-center rounded-[12px] border-2 border-[#d9a62e]/20 bg-[#d9a62e]/10 text-[#d9a62e]">
                    <ListFilter size={16} />
                  </span>
                </div>
              ...
              <button
                ...
                className="group relative mt-5 flex w-full items-center gap-3 overflow-hidden rounded-[27px] border-2 border-foreground bg-gradient-to-br from-[#7764e8]/12 via-card to-[#35a995]/12 p-4 text-left shadow-[4px_4px_0_rgba(0,0,0,0.1)] transition-all hover:-translate-y-1 hover:shadow-[6px_6px_0_rgba(0,0,0,0.15)] active:translate-y-0"
              >
                <DoodleStar className="-right-1 -top-2 size-7 rotate-12 text-[#ee6f96]/40" />
                ...
                <span className="min-w-0">
                  <span className="block text-sm font-black text-foreground">
                    {t('ai.title', {
                      defaultValue: 'Ask Todo AI',
                    })}
                  </span>
                  <span className="mt-0.5 block text-xs font-bold uppercase tracking-tight text-muted-foreground">
                    {t('ai.subtitle', {
                      defaultValue:
                        'Plan, create or manage tasks.',
                    })}
                  </span>
                </span>

                <span className="ml-auto text-lg font-black text-[#7764e8] transition-transform group-hover:translate-x-1">
                  →
                </span>
              </button>
            </aside>
